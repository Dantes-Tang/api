...
/** 
   ...
   */  
  public void sendMime(String to,String cc, Map model,String attachName,String attachPath ) throws MailException {
	  this.attachmentFilename=attachName;
	  this.attachmentPath=attachPath;
      sendMime(mergeSimpleMessage(to,cc,model));
  }  
   ...
   * @return 
   */  
  public SimpleMailMessage mergeSimpleMessage(String to,String cc, Map<String, Object> model) {  
       ...
       MimeMessagePreparator preparator = new MimeMessagePreparator(){  
          ...
          public void prepare(MimeMessage mimeMessage) throws Exception {  
              // TODO Auto-generated method stub  
               ...
               FileSystemResource file = new FileSystemResource(new File(getAttachmentPath()));  
               message.addAttachment(getAttachmentFilename(),file );
               }
